...
For the purposes of this course, I have cleaned and pruned the original dataset, and saved the resulting file in R format (`.Rdata`). The census data are in aggregate format at the district level and is labelled ‘data_census’. The data and relevant documentation will be available in the [*data* folder](ls/data/).
